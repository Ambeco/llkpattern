 ...
 *
 * <p>This is very similar to {@link Pattern}, except that it
...
public class Ll1Pattern {
	...
	public static Ll1Pattern compile(String regex) {
		return compile(regex, 0);
	}

	public static Ll1Pattern compile(String regex, int flags) {
		throw new UnsupportedOperationException("TODO: implement Ll1Pattern#compile");
	}
	...
	Ll1Pattern(String pattern, int flags) {
